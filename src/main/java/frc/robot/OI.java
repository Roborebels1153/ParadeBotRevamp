...
public class OI {
  ...
  public static final int OVERRIDESTICK_LEFT_Y = 1;
	public static final int OVERRIDESTICK_RIGHT_X = 4;
	public static final int OVERRIDESTICK_RIGHT_Y = 5;
	public static final int OVERRIDESTICK_TRIGGER_LEFT = 2;
